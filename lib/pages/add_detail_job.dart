...
class AddDetailJob extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future.microtask(() {
      jobTypeC.setFilterTask(selectedJob.value == 'Cleaning' ? 1 : 2).then((value) {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 8), // jarak antara teks utama dan error
                  if (selectedImageBeforeError.isNotEmpty)
                    Flexible(
                      child: Text(
                        selectedImageBeforeError.value,
                        style: const TextStyle(color: Colors.red, fontSize: 13),
                        overflow: TextOverflow.ellipsis, // biar gak kepanjangan
                      ),
                    ),
                ],
              ),
                  ...
                  onPressed: () async {
                    if (formKey.currentState!.validate()) {
                      ...
                      AppDialog.confirm(
                        ...
                        message: "Apakah kamu yakin ingin menyimpan data pekerjaan?",
                        ...
                        onConfirm: () async {
                          ...
                          final result = await jobC.create(
                            ...
                            int.parse(jobTypeC.tasks.where((task) => task.name == selectedJobType.value).first.id),
                            selectedFloor.value,
                            infoC.text,
                            imgBefore,
                            imgAfter
                          ...
                          if (result == 'ok'){
                            ...
                            AppSnackbarRaw.success('Berhasil menambah data pekerjaan!');
                          }else{
