...
class NonCleaningStaffWidget extends StatelessWidget {
  final List<StaffJobModel> data;
  const NonCleaningStaffWidget({super.key, required this.data});
  ...
  Widget build(BuildContext context) {
    ...
    if (data.isEmpty) {
      return const Center(child: Text('Belum ada pekerjaan Non-Cleaning.'));
    }
